...
tf.app.flags.DEFINE_string('eval_dir', './grozi_eval',
                           """Directory where to write event logs.""")
tf.app.flags.DEFINE_string('eval_data', 'test',
                           """Either 'test' or 'train_eval'.""")
tf.app.flags.DEFINE_string('checkpoint_dir', './grozi_train',
...
def evaluate():
  ...
  with tf.Graph().as_default() as g:
    ...
    images, labels = alexnet.distorted_inputs(eval_data=eval_data)
