...
def distorted_inputs(eval_data):
  ...
  return alexnet_input.distorted_inputs(eval_data, data_dir=FLAGS.data_dir,
...
def inputs(eval_data):
  ...
  if not FLAGS.data_dir:
    raise ValueError('Please supply a data_dir')
  # data_dir = os.path.join(FLAGS.data_dir, 'grozi-tide-bin')
  return alexnet_input.inputs(eval_data=eval_data, data_dir=FLAGS.data_dir,
                              batch_size=FLAGS.batch_size)
